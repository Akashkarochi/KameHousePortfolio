...
export default function TvScreen(props)
{
    ...
    <group ref={logosRef}>
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://github.com/Akashkarochi")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://www.akashkarochi.in")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://www.linkedin.com/in/akashkarochi/")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.07, 0.1, 0.1]}
        onClick={() => handleClick("./CV/CVAkashKarochi.pdf")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]}
        onClick={() => handleClick("https://github.com/Akashkarochi/KameHousePortfolio")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        onClick={() => handleClick("mailto:akashkarochi463@gmail.com")}
      >
        <planeGeometry/>
